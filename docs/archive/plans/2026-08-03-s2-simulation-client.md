...
- Modify: `apps/lab/AGENTS.md`, `packages/engine/CLAUDE.md`, `AGENTS.md` (racine), `docs/archive/specs/2026-08-02-hd2d-reboot-design.md`
...
`docs/archive/specs/2026-08-02-hd2d-reboot-design.md` : amender la ligne du tableau des
