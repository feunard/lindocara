...
**Spec:** `docs/archive/specs/2026-07-19-adventure-state-design.md` — Decisions bind. This is the first tranche to touch the game runtime; the two-players-two-rules, one-command-per-tick, and server-decides-outcomes invariants in CLAUDE.md are the law.
