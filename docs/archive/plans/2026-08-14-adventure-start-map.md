...
Increment 2 of [`docs/archive/specs/2026-08-14-spawn-and-start-map-design.md`](../specs/2026-08-14-spawn-and-start-map-design.md). Increment 1 (drawing the per-map hero start point) already shipped.
