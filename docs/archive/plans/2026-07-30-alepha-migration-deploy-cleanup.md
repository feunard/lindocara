...
- Spec: `docs/archive/specs/2026-07-29-alepha-migration-design.md` (Tranche 4 — cleanup + deploy). Prod is disposable (owner ruling: "on va l'exploser la prod, 0 migration de données").
