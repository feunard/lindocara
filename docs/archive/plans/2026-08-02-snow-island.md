...
**Le spec :** [`docs/archive/specs/2026-08-02-snow-island-design.md`](../specs/2026-08-02-snow-island-design.md). Le lire avant la Task 1.
...
### Task 7b: La glisse verrouillée — ABANDONNÉE (2026-08-03)

**Livrée puis annulée le même jour.** La règle de Pokémon Argent — entrer sur la glace verrouille la
direction, l'entrée est ignorée, on file jusqu'à buter — a été implémentée (règle pure, onze tests,
butoirs authorés dans le lac), jouée, et **jugée « nul » par l'auteur**. Retour à la glisse
contrôlée de la Task 3.

Les commits `80429f79` et `2f78f890` sont annulés par `56e47b38` ; la règle et ses tests restent
lisibles dans l'historique si l'idée revient. Voir la section correspondante du spec pour ce qu'on en
retient — l'essentiel étant que le labo a permis de construire, jouer, juger et jeter en quelques
heures, sans que le jeu soit touché.

**Ce qui subsiste de cette task : rien dans le code.** Le son de glisse de la Task 6 est restauré tel
qu'il était, piloté par l'intensité du dérapage.
