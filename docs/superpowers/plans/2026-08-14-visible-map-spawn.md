...
Increment 1 of [`docs/superpowers/specs/2026-08-14-spawn-and-start-map-design.md`](../specs/2026-08-14-spawn-and-start-map-design.md). Increment 2 (`adventures.startMapId`, retiring the `spawn` event kind) is **out of scope here** and earns its own plan.
