...
const allowed=['/studio/pixel-art/priest-prototype/','/studio/styles/lcpixel/','/packages/renderer/src/assets/bonus/priest-prototype/','/packages/renderer/src/assets/bonus/assassin-v2/','/artifacts/priest-motion/candidate/','/artifacts/priest-motion/before/','/artifacts/priest-handedness/before/','/artifacts/priest-prototype/pilot/','/artifacts/actor-quality/'];
