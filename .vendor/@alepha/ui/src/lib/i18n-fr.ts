...
export const uiFr: Record<string, string> = {
  ...
  "admin.workflows.cancel": "Annuler",
  "admin.workflows.cancelConfirm":
    "Arrêter cette exécution ? Les étapes restantes ne seront pas exécutées.",
  "admin.workflows.cancelTitle": "Annuler le workflow",
  "admin.workflows.cancelled": "Workflow annulé",
  "admin.workflows.colCreated": "Créé le",
  "admin.workflows.colDuration": "Durée",
  "admin.workflows.colError": "Erreur",
  "admin.workflows.colFailed": "Échecs",
  "admin.workflows.colName": "Nom",
  "admin.workflows.colOnError": "En cas d'erreur",
  "admin.workflows.colPending": "En attente",
  "admin.workflows.colPriority": "Priorité",
  "admin.workflows.colRunning": "En cours",
  "admin.workflows.colStatus": "Statut",
  "admin.workflows.colStep": "Étape",
  "admin.workflows.colSteps": "Étapes",
  "admin.workflows.colTriggeredBy": "Déclenché par",
  "admin.workflows.compensate": "Compenser",
  "admin.workflows.compensateConfirm":
    "Exécuter les fonctions de compensation de chaque étape terminée, en ordre inverse ?",
  "admin.workflows.compensateTitle": "Compenser le workflow",
  "admin.workflows.compensated": "Compensation lancée",
  "admin.workflows.execsDescription": "Exécutions de ce workflow.",
  "admin.workflows.noExecs": "Aucune exécution pour l'instant.",
  "admin.workflows.none": "Aucun workflow enregistré.",
  "admin.workflows.restart": "Redémarrer",
  "admin.workflows.restartConfirm":
    "Démarrer une nouvelle exécution avec la même charge utile ?",
  "admin.workflows.restartTitle": "Redémarrer le workflow",
  "admin.workflows.restarted": "Workflow redémarré",
  "admin.workflows.retried": "Workflow relancé",
  "admin.workflows.retry": "Relancer",
  "admin.workflows.retryConfirm":
    "Reprendre cette exécution à partir de l'étape en échec ?",
  "admin.workflows.retryTitle": "Relancer le workflow",
  "admin.workflows.searchPlaceholder": "Rechercher…",
  "admin.workflows.statusAll": "Tous les statuts",
  "admin.workflows.viewExecutions": "Voir les exécutions",
};
