...
export const HARVEST_PRESET_LABEL: Record<HarvestPresetId, MessageKey> = {
  ...
  tree_update_1: "editor.harvest.preset.treeUpdate1",
  tree_update_2: "editor.harvest.preset.treeUpdate2",
  tree_update_3: "editor.harvest.preset.treeUpdate3",
  tree_update_4: "editor.harvest.preset.treeUpdate4",
  tree_update_5: "editor.harvest.preset.treeUpdate5",
  tree_update_6: "editor.harvest.preset.treeUpdate6",
