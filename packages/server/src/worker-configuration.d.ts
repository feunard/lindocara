/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./packages/server/src/worker-configuration.d.ts` (hash: 18f402044978b1569e4560982b1967be)
// Runtime types generated with workerd@1.20260714.1 2026-07-08
interface __BaseEnv_Env {
  DB: D1Database;
  AUTH_CREDENTIAL_RATE_LIMITER: RateLimit;
  AUTH_ORIGIN_RATE_LIMITER: RateLimit;
  SESSION_SECRET: string;
  WORLD: DurableObjectNamespace<import("./index").World>;
  CHARACTER_PRESENCE: DurableObjectNamespace<import("./index").CharacterPresence>;
  HERO_PRESENCE: DurableObjectNamespace<import("./index").HeroPresence>;
