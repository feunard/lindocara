...
export const GENERATED_SHARED_PATH = path.join(
  ...
  "engine",
  "src",
  "generated/tiny-swords-catalog.ts",
);
  ...
  return [
    {
      ...
      editor: {
        ...
        collider: { x: -96, y: -64, width: 192, height: 64 },
    ...
    },
    {
      ...
      editor: {
        ...
        collider: { x: -32, y: -192, width: 64, height: 192 },
        terrainOverride: "walkable",
