...
- Adventure/map exploration, biome ambience and combat tracks are listed in
  [`audio/CREDITS.md`](./audio/CREDITS.md). Profile soundtrack tracks under `audio/music/` are
  generated in-house; their exact prompt, seed and parameters live in
  `studio/musics/generations.json`.
