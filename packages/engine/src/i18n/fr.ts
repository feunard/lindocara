...
export const fr: Record<keyof typeof en, string> = {
  ...
  "editor.audio.mapHint":
    "Chaque canal peut hériter de l’aventure, être coupé, ou utiliser un son propre à cette carte.",
  "editor.audio.music": "Musique d’exploration",
  "editor.audio.ambience": "Ambiance du biome",
  "editor.audio.combatMusic": "Musique de combat",
