...
export const fr: Record<keyof typeof en, string> = {
  ...
  "combat_stats.title": "Statistiques de combat",
  "combat_stats.dodge": "Esquive",
  "combat_stats.parry": "Parade",
  "combat_stats.physical_resistance": "Résistance physique",
  "combat_stats.magical_resistance": "Résistance magique",
  "combat_stats.critical": "Coup critique",
  ...
  "merchant.stock.unlimited": "Stock illimité",
  ...
  "event.combat.dodged": "Attaque esquivée.",
  "event.combat.parried": "Attaque parée.",
  "event.combat.group_required": "Cet ennemi exige au moins {count} héros combattant ensemble.",
  ...
  "event.merchant.out_of_stock": "Cet article est épuisé.",
  ...
  "editor.monster.rank.groupHint": "Nécessite au moins {count} héros du groupe à proximité.",
  "editor.monster.respawnMode": "Après la défaite",
  "editor.monster.respawnMode.timed": "Réapparition après le délai standard",
  ...
  "editor.event.cmd.shop.empty": "Cette boutique ne contient aucun article.",
  "editor.event.cmd.shop.item": "Article {index}",
  "editor.event.cmd.shop.stockMode": "Type de stock",
  "editor.event.cmd.shop.stockModeFor": "Type de stock de l’article {index}",
  "editor.event.cmd.shop.unlimited": "Illimité",
  "editor.event.cmd.shop.limited": "Limité",
  "editor.event.cmd.shop.stock": "Stock initial",
  "editor.event.cmd.shop.stockFor": "Stock initial de l’article {index}",
  "editor.event.cmd.shop.remove": "Retirer l’article {index}",
  "editor.event.cmd.shop.add": "Ajouter un article",
