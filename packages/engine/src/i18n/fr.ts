...
export const fr: Record<keyof typeof en, string> = {
  ...
  "editor.picker.title": "Éditeur de cartes",
  "editor.picker.subtitle": "Ouvrez une carte existante ou créez-en une nouvelle.",
  "editor.picker.existing": "Vos cartes",
  "editor.picker.existingHint": "Choisissez la carte que vous souhaitez modifier.",
  "editor.picker.create": "Nouvelle carte",
  "editor.picker.empty": "Aucune carte pour l’instant",
  "editor.picker.emptyHint": "Créez une carte pour commencer une nouvelle aventure.",
