...
export const en = {
  ...
  "editor.picker.title": "Map editor",
  "editor.picker.subtitle": "Open an existing map or create a new one.",
  "editor.picker.existing": "Your maps",
  "editor.picker.existingHint": "Choose the map you want to edit.",
  "editor.picker.create": "New map",
  "editor.picker.empty": "No maps yet",
  "editor.picker.emptyHint": "Create a map to start a new adventure.",
