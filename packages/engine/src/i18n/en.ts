...
export const en = {
  ...
  "editor.stairs.direction.west": "Left",
  "editor.stairs.transition": "Connected levels",
  "editor.stairs.transitionLevels": "Level {low} ↔ {high}",
  "editor.stairs.hint":
    "Choose the uphill direction. The ramp uses 2 cells along the cliff: click the low cell. Heroes climb towards {up} and descend towards {down}.",
