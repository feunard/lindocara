...
export const en = {
  ...
  "editor.audio.mapHint":
    "Each channel can inherit from the adventure, be silent, or use a map-specific track.",
  "editor.audio.music": "Exploration music",
  "editor.audio.ambience": "Biome ambience",
  "editor.audio.combatMusic": "Combat music",
