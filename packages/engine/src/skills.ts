...
export const CLASS_SKILLS: Readonly<Record<PlayerClass, readonly SkillDefinition[]>> = {
  ...
  peasant: [
    ...
    },
    {
      ...
      effect: "area_heal",
      cooldownMs: 4_800,
      range: PEASANT_SUPPORT_SKILLS[3].radius,
      radius: PEASANT_SUPPORT_SKILLS[3].radius,
      durationMs: PEASANT_SUPPORT_SKILLS[3].durationMs,
      power: PEASANT_SUPPORT_SKILLS[3].power,
      icon: "🧺",
    },
    {
      id: "makeshift_camp",
