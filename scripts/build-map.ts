...
function emit(
  ...
  return `// GENERATED by scripts/build-map.ts — do not edit by hand. Run: yarn map:build
...
writeFileSync(
  "packages/engine/src/generated/zones/verdant-reach-tiles.ts",
  emit("Verdant Reach", "VERDANT_REACH_TILES", verdant),
);

const test = rasteriseFlat(TEST_ZONE_TERRAIN, TEST_ZONE_TERRAIN.obstacles);
writeFileSync(
  "packages/engine/src/generated/zones/mmo-test-zone-tiles.ts",
...
writeFileSync(
  "packages/engine/src/generated/zones/sunken-isles-tiles.ts",
