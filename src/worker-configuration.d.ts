/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 638836ec343db89b67c6eba87a212ce8)
// Runtime types generated with workerd@1.20260708.1 2026-07-08 
interface __BaseEnv_Env {
	...
	WORLD: DurableObjectNamespace<import("./server/index").World>;
	CHARACTER_PRESENCE: DurableObjectNamespace<import("./server/index").CharacterPresence>;
	HERO_PRESENCE: DurableObjectNamespace<import("./server/index").HeroPresence>;
	GAME_SESSION: DurableObjectNamespace<import("./server/index").GameSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server/index");
		durableNamespaces: "World" | "CharacterPresence" | "HeroPresence" | "GameSession";
	}
